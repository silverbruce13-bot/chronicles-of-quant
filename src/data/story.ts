    ...
    ko: [
        {
            ...
            content: [
                ...
                "이 거대한 시간의 무기는 [[단순한 덧셈을 폭발적인 곱셈으로|단리(덧셈)는 매년 똑같이 원금에만 10%가 붙지만, 복리(곱셈)는 수십 년이 지나면 불어난 금액 전체에 복리로 붙어 눈덩이처럼 커집니다.]] 바꾸어 놓았습니다. 고대 수학자들은 원금이 대체 언제 두 배로 불어나는지를 가늠하기 위해 치열하게 머리를 맞댔고, 이는 훗날 '72의 법칙'이라는 직관적 공식으로 완성되었습니다. 복리라는 괴물은 [[거대한 자본을 축적시켰고|투자자들이 돈을 불려주는 이자의 마법을 믿고 돈을 모았기 때문에, 이 막대한 자금력으로 대규모 주식회사가 탄생할 수 있었죠!]], 이 자본은 머지않아 인류 최초의 '주식 시장'이라는 거대한 투기장을 탄생시킬 거름이 됩니다."
            ],
        ...
        },
        {
            ...
            content: [
                "복리의 마법으로 축적된 거대한 자본은 주식 시장으로 흘러들어갔고, 수많은 사람들은 가격이 오를지 내릴지 예측하려는 [[끝없는 욕망|인간은 수익 패턴을 예측하고 싶어 하지만, 주식 시장의 내일 방향은 마치 동전 던지기처럼 알 수 없다는 게 랜덤워크 이론이에요.]]에 사로잡혔습니다. 1900년, 파리 증권거래소의 광기 어린 외침 속에서, 루이 바슐리에라는 이름 모를 젊은 수학자는 군중과는 전혀 다른 곳을 바라보고 있었습니다.",
                "그는 과거의 어떠한 패턴이나 호재, 악재도 내일의 주가를 알려주지 못한다는 섬뜩한 진실을 수학적으로 증명해냈습니다. 시장 가격은 마치 물 위에 떠 있는 꽃가루처럼 이리저리 부딪히며 [[무작위로 표류할 뿐|어제 아무리 많이 올랐다고 해도 내일 떨어질 확률이 절반, 오를 확률이 절반이라는 점이죠. 오직 불확실성만 존재해요!]]이라는 것이죠. 내일의 주가는 오직 오늘의 주가에 아무런 방향성 없는 '[[랜덤워크|마치 술 취한 사람의 걸음걸이처럼, 과거의 움직임이 미래의 방향을 전혀 예측해주지 못하는 상태를 말해요!]]'를 더한 것과 같았습니다.",
        ...
        },
        {
            ...
            content: [
                "바슐리에가 발견한 '예측 불가능성'은 1970년대 이르러 전 세계 투자자들에게 엄청난 공포로 다가왔습니다. 주가가 미친 듯이 요동치는 이 무작위의 폭풍 속에서, 사람들은 내 자산을 안전하게 지켜줄 일종의 보험인 '[[옵션이라는 방패|미래에 주가가 휴지조각이 되어도 '미리 정해둔 가격'에 무조건 팔 수 있는 권리증서예요. 떨어질까 두려운 마음을 보호하는 보험과 똑같죠.]]'를 원했습니다. 하지만 이 방패의 적당한 가격이 얼마인지는 아무도 몰랐습니다.",
                "이때 시카고의 천재 학자들(블랙, 숄스, 머튼)이 등장합니다. 그들은 [[물리학의 열전도 방정식까지 가져와|시장이 미친 듯이 요동치는 현상(변동성)을, 달궈진 철판에서 열이 불규칙하게 퍼져나가는 물리학 공식으로 계산해냈어요. 엄청난 융합이죠!]] 금융 시장에 접목했습니다. 그리고 주식과 옵션을 정교한 비율로 섞어 위험(Risk)을 완벽하게 '0'으로 지워버리는 기적과도 같은 계산을 해냅니다. 이것이 바로 세상을 바꾼 '[[블랙-숄스 방정식|옵션 가격을 결정하는 노벨상 수상 공식이야. 위험을 완전히 제거하는 포트폴리오(무위험 헤지)를 수학적으로 증명해냈지!]]'입니다.",
        ...
        },
        {
            ...
            content: [
                ...
                "이들은 복잡한 월스트리트의 호가창 시스템을 전부 뜯어내고, 놀랍도록 단순하고 우아한 식 하나를 블록체인 위에 새겨 넣었습니다. 오직 [[두 자산의 곱은 항상 일정해야 한다(x*y=k)|사과(x)와 오렌지(y)의 전체 갯수를 곱한 값이 변하지 않으면, 사과가 줄어들 때 오렌지의 가치(가격)가 자동으로 비싸지며 균형을 맞춘답니다!]]는 원리를 통해, 누군가 호가를 내지 않아도 알고리즘이 스스로 가격을 결정해 주는 '[[AMM|자동화된 마켓 메이커(Automated Market Maker). 누군가 호가를 내지 않아도, 수학 공식(x*y=k)에 의해 자동으로 가격이 결정되는 스마트 컨트랙트야!]]'를 탄생시킵니다.",
                "바빌론의 점토판에서 시작되어 피같이 뜨거운 탐욕으로 얼룩졌던 금융의 역사는, 이제 영원히 멈추지 않고 스스로 돌아가는 [[수학의 기어(Gear)|사람이 직접 주문을 승인해주지 않아도, 프로그래밍된 스마트 컨트랙트(코드)가 영원히 멈추지 않고 스스로 거래를 성사시킵니다. 거대한 블록체인 자판기 같죠!]]로 진화했습니다. 이는 소수에게 독점되던 지식과 부를 투명하게 개방하여 모두와 공유하려는 '헤븐 프로젝트'의 숭고한 정신과 맞닿아, 새로운 우주 시대의 경제 시스템으로 나아가는 첫걸음이 되고 있습니다."
            ],
            tutorialType: 'amm',
            theoryDetail: {
    ...
    en: [
        {
            ...
            content: [
                ...
                "This colossus weapon of time transformed simple addition into [[explosive multiplication|Simple interest adds the same amount every year, but compound interest multiplies the entire accumulated amount, making it grow like a snowball rolling down a mountain!]]. Ancient mathematicians fiercely wracked their brains to estimate exactly when the principal would double, efforts which crystallized into the intuitive 'Rule of 72'. The beast known as compound interest [[amassed unimaginable capital|Because investors trusted the magic of growing money, they pooled massive funds together, which birthed the first large-scale joint-stock companies!]], which soon laid the fertile groundwork for humanity's first monumental arenas of speculation: the stock markets."
            ],
            tutorialType: 'compound',
            theoryDetail: {
        ...
        },
        {
            ...
            imagePath: '/assets/images/ch2.png',
            content: [
                "The massive capital accumulated through the magic of compound interest rapidly flooded into the stock market. Countless people became consumed by the [[endless desire to predict|Humans always look for patterns, but the Random Walk theory states that predicting tomorrow's market direction is as impossible as predicting a coin toss.]] whether prices would rise or fall. In 1900, amid the frantic shouting of the Paris Bourse, a young and obscure mathematician named Louis Bachelier was looking in an entirely different direction from the madness of the crowd.",
                "He mathematically proved a chilling truth: no past pattern, good news, or bad news could ever predict tomorrow's stock price. He argued that market prices merely drift aimlessly, [[collide randomly like pollen|Even if a stock went up 10 days in a row, the probability of it going down tomorrow is still independent. It just drifts randomly!]] suspended in water. Tomorrow's price is simply today's price plus a completely unpredictable '[[random walk|Just like a drunkard's walk, the past movement cannot predict the future direction at all!]]'.",
        ...
        },
        {
            ...
            imagePath: '/assets/images/ch3.png',
            content: [
                "The 'unpredictability' discovered by Bachelier returned to haunt global investors in the 1970s as a terrifying reality. Amidst a chaotic storm of wildly fluctuating stock prices, people desperately sought a financial [[shield called an 'option'|It's a right allowing you to sell a stock at a pre-set price even in the event of a total market crash. It functions exactly like an insurance policy!]] to protect their wealth. Yet, absolutely no one knew what the fair price for this shield should be.",
                "This is when brilliant scholars in Chicago (Black, Scholes, and Merton) stepped onto the stage. They essentially borrowed the [[heat equation from physics|Isn't it amazing? They took a complex calculus formula calculating how heat spreads across a metal plate and perfectly applied it to stock market volatility!]], originally designed to calculate how heat dissipates through metal, and applied it to the financial markets. By precisely blending stocks and options, they performed a miraculous calculation that mathematically erased all 'Risk' down to zero. This was the world-changing '[[Black-Scholes Equation|It's the Nobel Prize-winning formula for pricing options. It mathematically proved a portfolio that completely eliminates risk (risk-free hedging)!]]'.",
        ...
        },
        {
            ...
            content: [
                ...
                "They completely tore down the complex order book systems of Wall Street and inscribed a shockingly simple, elegant equation onto the blockchain. By utilizing the principle that the [[product of two reserve assets must always remain constant (x*y=k)|If the multiplied quantity of Apples(x) and Oranges(y) never changes, someone taking Apples means the value of Oranges automatically shoots up to keep the balance!]], they birthed the '[[AMM|Automated Market Maker. Even without someone placing an order, the price is automatically determined by a smart contract mathematically (x*y=k)!]]'. This algorithm inherently determines prices and provides infinite liquidity entirely on its own.",
                "The history of finance, which began with Babylonian clay tablets and was long stained by fervent greed, has now geometrically evolved into [[eternal spinning gears of mathematics|Instead of human brokers manually matching orders, programmed smart contracts (code) autonomously execute trades and determine prices forever on the blockchain!]]. This perfectly aligns with the noble spirit of the 'Heaven Project'—transparently opening and sharing knowledge and wealth previously monopolized by a few. This automated machine marks our very first monumental step toward the ultimate economic system of the space age."
            ],
            tutorialType: 'amm',
            theoryDetail: {
                title: "AMM (Automated Market Maker) & x*y=k",

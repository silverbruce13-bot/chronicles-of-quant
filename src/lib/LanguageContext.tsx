...
const translations = {
    ko: {
        ...
        'app.welcome_desc': '"우리는 Sisyphus와 함께 일합니다. 모든 지식은 투명하게 공개되며, 협력과 공유를 통해 더 나은 세계를 구축합니다. 이 튜토리얼 앱은 과거의 지혜를 모아 우주시대로 나아가는 헤븐 프로젝트의 첫 걸음입니다."',
        ...
        'chapter.footer_hint': 'HEAVEN PROJECT : Sisyphus Protocol Active'
    },
    en: {
        'app.title': 'Chronicles of Quant',
        ...
        'app.welcome': 'Welcome Collaborator',
        'app.welcome_desc': '"We work with Sisyphus. All knowledge is transparently shared, and we build a better world through cooperation and sharing. This tutorial app is the first step of the Heaven Project, gathering past wisdom to advance into the space age."',
        'app.system_ready': 'System Ready • No Human Bottleneck',
